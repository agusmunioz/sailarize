...
public class TemplateTest {
	...
	public void startsWithText() {
		...
		Assert.assertEquals(
				"Unexpected printing template with text at start and no text at end.",
				expected, actual);
	...
	public void endsWithText() {
		...
		Assert.assertEquals(
				"Unexpected printing template with text at end and no text at start.",
				expected, actual);
	...
	public void startsAndEndsWithText() {
		...
		Assert.assertEquals(
				"Unexpected printing with not repeated characters in the template.",
				expected, actual);
	...
	public void oneVariable() {
		...
		Assert.assertEquals("Unexpected printing wiht only one variable",
				expected, result);
	...
	public void instanceVariable() {
		...
		Assert.assertEquals("Unexpected printing wiht instance variable only",
				expected, result);
	}
